          ...
          <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
            <div className="mb-12 max-w-[570px] lg:mb-0">
              ...
              <p className="text-base leading-relaxed mb-9 text-body-color">
                We are dedicated to delivering reliable, eco-friendly solutions
                that enhance every property's beauty, functionality, and safety.
                We take pride in our commitment to customer satisfaction,
                professionalism, and environmental responsibility as we strive
                to be the premier choice for comprehensive outdoor care in our
                community.
              </p>
              <div className="mb-8 flex w-full max-w-[370px]">
                ...
                <div className="w-full">
                  ...
                  <p className="text-base text-body-color">
                    50 445 Brintnell Blvd,NW Edmonton, AB , Canada
                  </p>
                </div>
              </div>
              <div className="mb-8 flex w-full max-w-[370px]">
                ...
                <div className="w-full">
                  ...
                  <p className="text-base text-body-color">
                    +1 (780) 814-3339 -Prabash
                  </p>
                  <p className="text-base text-body-color">
                    +1 (587) 501-6915 -Dharshana
                  </p>
                </div>
              </div>
              <div className="mb-8 flex w-full max-w-[370px]">
